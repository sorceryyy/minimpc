...
class ColorChangingRL(gym.Env):
    ...
    def step(self, action):
        ...
        old_matches = self._calculate_matches()
        ...
        reward = (matches - old_matches) / self.num_objects
    ...
    def current_reward(self):
        ...
        return matches / self.num_objects
    ...
    def _set_obs_dict_from_grid(self, state:np.ndarray):
